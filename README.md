...
4. set up your phone by downloading **Synthbridge** on the playstore(not sure on IOS, I don't have access to an IOS device to test on) and connecting to your microcontroller inside the app (you cannot connect via normal bluetooth because it is over BLE). It should be named "BLE-MIDI".
5. once completed, you can modify your instrument presets in the app settings, and then play with all the various features the app has.
